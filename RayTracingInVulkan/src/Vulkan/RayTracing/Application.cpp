...
void Application::CreateSwapChain()
{
	...
	const std::vector<ShaderBindingTable::Entry> hitGroups = { {rayTracingPipeline_->TriangleHitGroupIndex(), {}},{rayTracingPipeline_->ProceduralHitGroupIndex(), {}}, {rayTracingPipeline_->ProceduralCubeHitGroupIndex(), {}}, {rayTracingPipeline_->ProceduralCylinderHitGroupIndex(), {}}, {rayTracingPipeline_->ProceduralGaussHitGroupIndex(), {}} // WLZ
	/*, {rayTracingPipeline_->ProceduralMandelbulbHitGroupIndex(), {}}*/ };
#else
...
void Application::CreateBottomLevelStructures(VkCommandBuffer commandBuffer)
{
	...
	for (const auto& model : scene.Models())
	{
		...
		// WLZ
		else if (model.ProceduralGauss()) {
			geometries.AddGeometryGauss(scene, aabbOffset, 1, true);
		}
		else
